...
img_width: "65%"
featured: true
summary: "A tour of Gaussian-like behavior beyond simple addition, including multiplicative processes, logarithms, phases, and turbulence."
math: true
code: true
---
...
<script>
    ...
    <div class="plot-carousel">
        ...
        <img id="carousel1-img" src="{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n1.png" alt="Plot for n = 1">
    ...
    <img id="carousel2-img" src="{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n1.png" alt="Plot for n = 1">
    ...
    <div class="plot-carousel">
        ...
        <img id="carousel3-img" src="{{ '/' | relative_url }}CLT_plots/logrho_ideal_n1.png" alt="Plot for n = 1">
    ...
    const carouselData = {
        ...
        index: 0,
        images: [
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n1.png", label: "n = 1" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n2.png", label: "n = 2" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n3.png", label: "n = 3" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n5.png", label: "n = 5" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n10.png", label: "n = 10" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n20.png", label: "n = 20" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n30.png", label: "n = 30" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n50.png", label: "n = 50" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n100.png", label: "n = 100" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n200.png", label: "n = 200" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n300.png", label: "n = 300" },
            { src: "{{ '/' | relative_url }}CLT_plots/density_mach_lognormal_n500.png", label: "n = 500" }
        ]
        },
        carousel2: {
        index: 0,
        images: [
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n1.png", label: "n = 1" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n2.png", label: "n = 2" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n3.png", label: "n = 3" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n5.png", label: "n = 5" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n10.png", label: "n = 10" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n20.png", label: "n = 20" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n30.png", label: "n = 30" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n50.png", label: "n = 50" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n100.png", label: "n = 100" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n200.png", label: "n = 200" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n300.png", label: "n = 300" },
            { src: "{{ '/' | relative_url }}CLT_plots/log_mach_lognormal_n500.png", label: "n = 500" }
        ]
        },
        carousel3: {
        index: 0,
        images: [
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n1.png", label: "n = 1" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n2.png", label: "n = 2" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n3.png", label: "n = 3" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n5.png", label: "n = 5" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n10.png", label: "n = 10" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n20.png", label: "n = 20" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n30.png", label: "n = 30" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n50.png", label: "n = 50" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n100.png", label: "n = 100" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n200.png", label: "n = 200" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n300.png", label: "n = 300" },
            { src: "{{ '/' | relative_url }}CLT_plots/logrho_ideal_n500.png", label: "n = 500" }
        ]
        }
    };
