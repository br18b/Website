(() => {
  ...
  const STYLE = Object.freeze({
    faintOverviewRgba: __FAINT_OVERVIEW_RGBA__,
    faintZoomRgba: __FAINT_ZOOM_RGBA__,
    selectedContourRgba: __SELECTED_CONTOUR_RGBA__,
    faintWidth: __FAINT_CONTOUR_WIDTH__,
    faintCount: __FAINT_CONTOUR_COUNT__,
    selectedOverviewWidth: __SELECTED_OVERVIEW_WIDTH__,
    selectedZoomWidth: __SELECTED_ZOOM_WIDTH__,

    windowIdleStrokeRgba: __WINDOW_IDLE_STROKE_RGBA__,
    windowIdleFillRgba: __WINDOW_IDLE_FILL_RGBA__,
    windowNormalStrokeRgba: __WINDOW_NORMAL_STROKE_RGBA__,
    windowNormalFillRgba: __WINDOW_NORMAL_FILL_RGBA__,
    windowHoverStrokeRgba: __WINDOW_HOVER_STROKE_RGBA__,
    windowHoverFillRgba: __WINDOW_HOVER_FILL_RGBA__,
    windowIdleLineWidth: __WINDOW_IDLE_LINE_WIDTH__,
    windowNormalLineWidth: __WINDOW_NORMAL_LINE_WIDTH__,
    windowHoverLineWidth: __WINDOW_HOVER_LINE_WIDTH__,
    windowCornerRadius: __WINDOW_CORNER_RADIUS__,
    windowHoverDistancePixels: __WINDOW_HOVER_DISTANCE_PIXELS__,
    windowProximityRangeBoxWidths: __WINDOW_PROXIMITY_RANGE_BOX_WIDTHS__,
    windowProximityFalloff: __WINDOW_PROXIMITY_FALLOFF__,

    windowShowHoverLabel: __WINDOW_SHOW_HOVER_LABEL__,
    windowLabelPrefix: __WINDOW_LABEL_PREFIX__,
    windowLabelFont: __WINDOW_LABEL_FONT__,
    windowLabelBackgroundRgba: __WINDOW_LABEL_BACKGROUND_RGBA__,
    windowLabelTextRgba: __WINDOW_LABEL_TEXT_RGBA__,
    windowLabelPaddingX: __WINDOW_LABEL_PADDING_X__,
    windowLabelHeight: __WINDOW_LABEL_HEIGHT__,
    windowLabelCornerRadius: __WINDOW_LABEL_CORNER_RADIUS__,
    windowLabelGap: __WINDOW_LABEL_GAP__,
  });
